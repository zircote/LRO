...
*†Empirically measured savings at n $\geq$ 200 across two models (Section 6.2). Theoretical savings of ~96% assume optimal access ratio k/n = 0.02.*
...
**Design:** 5 strategies × 3 scales × 2 models × 15 tasks = 450 individual task evaluations.
