...
![Figure 1. E1 count accuracy across four strategies at three corpus scales. LRO dominates at all scales; inline collapses to 0--7%. Dashed line: 70% acceptance threshold.](/LRO/figures/fig2_count_accuracy_by_strategy.png)
...
![Figure 2. LRO/Inline API token ratio by corpus scale. Values below 1.0 indicate LRO saves tokens. Savings grow with corpus size; at n=50, Haiku LRO has slight overhead (1.28x).](/LRO/figures/fig1_token_ratio_by_scale.png)
...
![Figure 3. E1 access ratio (k/n) for LRO arm. Agents read 0--2% of offloaded records across all scales.](/LRO/figures/fig3_access_ratio.png)
...
![Figure 4. E2 descriptor ablation heatmap. Count accuracy by condition and scale for both models. C1--C4 (LRO variants) perform well; C5 (inline) fails. C4 bare pointer matches or exceeds C1 full descriptor.](/LRO/figures/fig4_descriptor_ablation.png)
...
![Figure 5. C1 (Full LRO) vs C5 (Inline) token ratio across scales.](/LRO/figures/fig5_e2_token_ratio.png)
...
![Figure 6. E3 goal achievement by condition and scale. Haiku achieves near-100% in both conditions; GPT-5-mini shows a recipe advantage of +13--20pp.](/LRO/figures/fig6_e3_goal_achievement.png)
